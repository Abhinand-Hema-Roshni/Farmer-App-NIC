...
//        mAuth=FirebaseAuth.getInstance();
        ...
        edtPhone = findViewById(R.id.sup_phone_editText);
        edtOTP = findViewById(R.id.sup_otp_editText);
        verifyOTPBtn = findViewById(R.id.sup_verify_otp_button);
        generateOTPBtn = findViewById(R.id.sup_sendotp_button);
back = findViewById(R.id.testBTN);
...
//        });
        ...
        back.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent i = new Intent(SignUpPage_1.this, SignUpPage_2.class);
                startActivity(i);
        ...
        generateOTPBtn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (TextUtils.isEmpty(edtPhone.getText().toString())) {
                    // when mobile number text field is empty
                    // displaying a toast message.
                        Toast.makeText(SignUpPage_1.this, "Please enter a valid phone number.", Toast.LENGTH_SHORT).show();
                } else {
                    // if the text field is not empty we are calling our
                    // send OTP method for getting OTP from Firebase.
        ...
        verifyOTPBtn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (TextUtils.isEmpty(edtOTP.getText().toString())) {
                    // if the OTP text field is empty display
                    // a message to user to enter OTP
                    Toast.makeText(SignUpPage_1.this, "Please enter OTP", Toast.LENGTH_SHORT).show();
                } else {
                    // if OTP field is not empty calling
                    // method to verify the OTP.
...
//        });
                ...
                .addOnCompleteListener(new OnCompleteListener<AuthResult>() {
                    ...
                    public void onComplete(@NonNull Task<AuthResult> task) {
                        if (task.isSuccessful()) {
                            ...
                            Toast.makeText(SignUpPage_1.this, task.getException().getMessage(), Toast.LENGTH_LONG).show();
                        }
                    }
                });
    }
    ...
    private PhoneAuthProvider.OnVerificationStateChangedCallbacks
        ...
        public void onVerificationFailed(FirebaseException e) {
            ...
            Toast.makeText(SignUpPage_1.this, e.getMessage(), Toast.LENGTH_LONG).show();
        }
    };
